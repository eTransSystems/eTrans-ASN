...
/**
 * Represents asn.1 Bit String object.
 * @author Fatih Batuk
 *
 */
public class BitString extends BerBitString
{
	public
	BitString()
	{
	...
	public
	BitString(String name, BitSet value)
	{
		super(value);
		setName(name);
		isInitialized = true;
	...
	/**
	 * To decode a BER encoded Byte value to a BerBitString automatically..
	 * @param parser
	 * @param in
	 * @throws IOException
	 */
