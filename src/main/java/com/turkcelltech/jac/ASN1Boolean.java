...
/**
 * Represents asn.1 BOOLEAN object.
 * 
 * @author Fatih BATUK
 */
public class ASN1Boolean extends BerBoolean
{
	/**
	 ...
	 * the object.
	 *<p>
	 * @param value a Boolean with the desired value.
	 */
	public ASN1Boolean(String name, boolean value)
	{
		super(value);
		setName(name);
		isInitialized = true;
	...
	/**
	 * to encode this boolean value in BER
	 */
	...
	/**
	 * To decode a BER encoded Byte value to a BerBoolean automatically..
	 * @param parser
	 * @param in
	 * @throws IOException
	 */
