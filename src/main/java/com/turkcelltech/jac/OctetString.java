...
/**
 * Represents asn.1 Octet String object.
 * 
 * @author Fatih Batuk
 *
 */
public class OctetString extends BerOctetString
{
	public
	OctetString()
	{
	...
	public
	OctetString(String name, byte[] val)
	{
		super(val);
		setName(name);
		isInitialized = true;
	...
	/**
	 * To decode a BER encoded Byte array to a BerOctetString..
	 * @param parser
	 * @param in
	 * @throws IOException
	 */
