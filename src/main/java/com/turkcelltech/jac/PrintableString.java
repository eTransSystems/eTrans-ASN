 ...
 *
 */
public class PrintableString extends BerPrintableString
{
	 ...
	 * the object.
	 * <p><b>ATTENTION !</b> This parameter is not the value of PrintableString object !
	 ...
	 * the object.
	 *<p>
	 * @param value : the value of PrintableString object.
	 */
	public PrintableString(String name, String value) throws AsnEncodingException
	{
		super(value);
		setName(name);
		isInitialized = true;
