...
/**
 * Represents asn.1 Null object.
 * @author Fatih Batuk
 *
 */

public class Null extends BerNull
{
	public Null() {
		super();
		isInitialized = true;
	...
	/**
	 * Constructs an empty NULL with the given name.
	 *<p>
	...
	/**
	 * to encode this null value in BER
	 */
	...
	/**
	 * To decode a BER encoded Byte value to a BerNull object..
	 * @param parser
	 * @param in
	 * @throws IOException
	 */
